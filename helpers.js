...
function renderSitePopup(){
    ...
    if (pp != undefined){
        if (pp.contest.name != undefined && pp.contest.name.length > 0){
            $('.popup-body').append('<img id="pp_img" class="pp_img_bg" src="//codecloud.cdn.speedyrails.net' + pp.photo_url + '" alt="pop up">');
            ...
            if (pp.photo_link.length > 0){
                $('.popup-body').html('<a id="pp_url" href="' + pp.photo_link +'"><img id="pp_img" src="//codecloud.cdn.speedyrails.net' + pp.photo_url + '" alt="pop up"></a>')
            }
            else{
